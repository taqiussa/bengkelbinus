                ...
                <div class="flex flex-col m-5">
                    <form class="w-full">
                        ...
                        <div class="flex items-center mb-2">
                            <input wire:model='iditem' type="hidden" id="iditem" class="w-full px-1 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:teal"/>
                            <div class="relative flex flex-col w-1/3 mx-1 mb-2 text-center border-b border-teal-500">
                                <select wire:model='category_id' class="block w-full px-1 py-2 pr-8 leading-tight bg-white border-none appearance-none focus:outline" autofocus>
                            ...
                            <div class="flex flex-col w-1/2 mx-1 mb-2 text-center border-b border-teal-500">
                                <input wire:model.defer='item' type="text" id="weight-pounds" class="w-full px-1 py-2 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline" placeholder="Item" aria-label="item" />
                            </div>
                        </div>
                        <div class="flex items-center">
                            <div class="relative flex flex-col w-1/3 px-1 mx-1">
                        ...
                        <div class="flex items-center mb-2">
                            <div class="flex flex-col w-1/3 mx-1 mb-2 text-center border-b border-teal-500">
                                <input wire:model.defer='jumlah' type="text" id="weight-pounds" class="w-full px-1 py-2 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" placeholder="Jumlah" aria-label="jumlah" />
                            </div>
                            <div class="flex flex-col w-1/2 mx-1 mb-2 text-center border-b border-teal-500">
                                <input wire:model='harga' type="text" id="weight-pounds" class="w-full px-1 py-2 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" placeholder="Harga" aria-label="harga" />
                            </div>
                        </div>
                        <div class="my-4">
